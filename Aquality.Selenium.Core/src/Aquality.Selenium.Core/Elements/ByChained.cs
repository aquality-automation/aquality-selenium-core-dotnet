...
{
    /// <summary>
    /// Mechanism used to locate elements within a document using a series of other look ups. This class
    /// will find all DOM elements that matches each of the locators in sequence
    /// </summary>
    /// <example>
    /// The following code will find all elements that match by2 and appear under an element that matches
    /// by1.
    /// <code>
    ...
    public class ByChained : By
    {
        ...
        {
            this.bys = bys ?? throw new ArgumentNullException(nameof(bys), "ByChained must have at least one By object");
        }
